...
happyExpList = Happy_Data_Array.listArray (0,62) ([35584,45056,8,12,0,12288,2,4,1024,0,0,45056,8,139,192,35584,45056,8,268,0,0,12288,8,131,2096,33536,0,4,64,1024,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","AExpr","NExpr","MExpr","Factor","Primary","digits","id","'+'","'-'","'*'","'/'","'^'","'('","')'","'%'","'!'","%eof"]
...
action_2 (11) = happyShift action_12
action_2 (12) = happyShift action_13
