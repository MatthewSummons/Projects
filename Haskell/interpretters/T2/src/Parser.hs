...
happyExpList = Happy_Data_Array.listArray (0,58) ([17664,35328,6144,49152,0,0,4,0,0,69,138,24,552,1104,4288,0,8832,17664,35328,0,0,0,0,0,6,12,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","AExpr","Term","Factor","Expon","Primary","digits","'+'","'-'","'*'","'/'","'^'","'('","')'","%eof"]
